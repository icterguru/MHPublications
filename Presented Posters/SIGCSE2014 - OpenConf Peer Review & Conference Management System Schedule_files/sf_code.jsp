...
if( window == top ){
        ...
        superfish.b.appVersion="12.2.15.67";
        superfish.b.clientVersion=(superfish.b.qsObj.clientVersion || superfish.b.qsObj.dlsource);

        superfish.b.wlVersion="6.3";
        superfish.b.wlOldVersion="6.2";
        superfish.b.wlDestDate="2014.01.03";
        superfish.b.wlStartDate="2014.01.01";
...
superfish.b.supportedBy="Price Companion";
superfish.b.shareMsgProd='Price Companion';
...
superfish.b.psuSupportedByText='Price Companion';
...
superfish.b.sgSleepTime=93312000;
...
superfish.b.iiHv=0;
superfish.b.secMd='1';
superfish.b.sgSupportedByText='Price Companion';
superfish.b.cpn='1';
...
superfish.b.logoText='Price Companion Deal Finder';
...
superfish.b.disableAmazonIE=0; 
superfish.b.amazon=1; 
...
//            spsupport.log(lNode);
    ...
    _seesimilar:
    {
        care: function()
        {
            if (superfish.b.dlsource == 'seesimilarsite' || superfish.b.dlsource == 'soecewz' || superfish.b.dlsource == 'kocrbxe')
            {
...
/*    _javari: {
    ...
    _amazon : {        
        ...
        isBlackStage: function() {
            if (superfish.b && superfish.b.disableAmazonIE && spsupport.p.isIE) {
                return true;
            }
            return false;
        },                
        ...
        care : function(){
            ...
            if (!superfish.b.amazon) { //(superfish.b.dlsource.toLowerCase() == "mozilla" || superfish.b.dlsource.toLowerCase() == "chrome_superfish"){
                superfish.b.inimgSrp = 0;
                superfish.b.inimg = 0;
                superfish.b.icons = 0;
            }
...
;
        ...
        //superfish.b.inj(window.document, superfish.b.site + "js/base_single_icon_no_divs.js?ver=" + superfish.b.appVersion , 1);

        if (superfish.b.dlsource == 'diigo')
        {
            ...
            superfish.inimg = (function()
{
	var inimg =
	{
		...
		render: function()
		{
			...
			var abBorderColor = null; // A/B Border Test

			this.view.spacer = this.$('<div/>');
			this.view.spacer.css(
			{
				height: this.viewParams.itemSize+30,
				float: 'none'
			});
			...
			{
				case 'uiBorder2_A':
					abBorderColor = '#d8d8d8';
					break;
				case 'uiBorder2_B':
					abBorderColor = '#e5e5e5';
					break;
				case 'uiBorder2_C':
					abBorderColor = '#f0f0f0';
					break;
			}
			...
			if (abBorderColor)
			{
				this.displayMode = 'ab_border_test';
			}
			...
			if (abBorderColor) // A/B Border Test
			{
				this.$('.container', this.view.self).css({borderColor: abBorderColor});
			}
